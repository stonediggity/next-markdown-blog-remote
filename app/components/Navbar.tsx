  ...
  return (
    <nav className="bg-slate-600 p-4 sticky top-0 drop-shadow-xl z-10">
      <div className="md:px-6 prose prose-xl mx-auto flex justify-between flex-col sm:flex-row">
        <h1 className="text-sm font-bold text-white grid place-content-center mb-2 md:mb-0">
          <Link
            href="/"
        ...
        <div className="flex flex-row justify-center sm:justify-evenly align-middle gap-6 text-white text-md">
          <Link
